        ...
        <>
            ...
            >
                ...
                <div style={modalButtonContainer}>
                    <button style={{ ...modalButton, backgroundColor: 'green', marginRight: '10px', flex: 1 }} onClick={handleOrderMore}>Order More</button>
                    <button style={{ ...modalButton, backgroundColor: 'green', marginLeft: '10px', flex: 1 }} onClick={handleOrderStatus}>Order Status</button>
                </div>
